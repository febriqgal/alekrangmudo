...
export default function AddDateIcon({
  ...
  return (
    ...
    >
      <path
        opacity="0.4"
        d="M3 7.5C3 5.29086 4.79086 3.5 7 3.5H17C19.2091 3.5 21 5.29086 21 7.5V9V18C21 20.2091 19.2091 22 17 22H7C4.79086 22 3 20.2091 3 18V9V7.5Z"
      />
      <path d="M17 3.5H7C4.79086 3.5 3 5.29086 3 7.5V9H21V7.5C21 5.29086 19.2091 3.5 17 3.5Z" />
      <path
        opacity="0.4"
        fill-rule="evenodd"
        clip-rule="evenodd"
